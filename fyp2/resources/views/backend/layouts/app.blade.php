                ...
                <ul class="menu-aside">
                    ...
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                         ...
                         <a href="{{ route('addproduct') }}">Add New Product</a>
                            <a href="{{ route('listproduct')}}">Product List</a>
                        </div>
                    </li>
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="{{ route('deliveredorder') }}">Delivered Order</a>
                    ...
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                          ...
                          <a href="{{ route('addseller') }}">Add New Seller</a>
                            <a href="{{ route('listseller') }}">Sellers list</a>
                        </div>
                    </li>
                    ...
                    <li class="menu-item has-submenu">
                        <a class="menu-link" href="page-sellers-cards.html">
                            <i class="icon material-icons md-store"></i>
                            <span class="text">Apparel / Pharmacies</span>
                        </a>
                        <div class="submenu">

                        
                          <a href="{{ route('addstore') }}">Add New Store</a>
                            <a href="{{ route('liststore') }}">Store list</a>
                        </div>
                    </li>


                    <li class="menu-item">
                        <a class="menu-link" href="{{ route('reviewlist') }}">
                    ...
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="{{ route('promotionslist') }}">All Promotions</a>
                            <a href="{{ route('addpromotion') }}">Add New Promotion</a>
