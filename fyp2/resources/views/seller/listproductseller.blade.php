...
@section('content')
       ...
       <section class="content-main">
                <div class="content-header">
                    ...
                    <div>
                        <a href="{{ route('addproductseller') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Create new</a>
                    </div>
                </div>
                <div class="card mb-4">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($allproducts as $product)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('editproductseller', ['id' => $product->id]) }}" class="btn btn-sm btn-brand rounded font-sm mt-15">View details</a>
                                        </td>
                                    </tr>
                                @endforeach 
